                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='relative group'>
                                <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200${
                                    ...
                                    <Mail className="h5 w-5" strokeWidth={2} />
                                </div>
                                <input
                                    type="email"
                                    value= {email}
                        ...
                        {error &&(
                            <div className="rounded-lg bg-red-50 border border-red-200 p-3" >
                                <p className='text-sx text-red-600 font-medium text-center'>{error}</p>
                            </div>
                        )}
                        {/*Submit Button */}
                        <button
                        ...
                        <span className='relative z-10 flex items-center justify-center gap-2'>
                            {loading? (
                                ...
                                <>
                                    Sign in
                                    <ArrowRight className= 'w-4 h-4 group-hover:translate-x-l transition-transform duration-200' strokeWidth= {2.5} />
                                </>
                            )}
                        </span>
