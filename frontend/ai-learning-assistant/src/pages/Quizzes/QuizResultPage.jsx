    ...
    <div className="max-w-5xl mx-auto">
                  ...
                  return (
                    <div
                      ...
                      className={`relative px-4 py-3 rounded-lg border-2 transition-all duration-200 ${
                        isCorrectOption
                          ? "bg-emerald-50 border-emerald-300 shadow-lg shadow-emerald"
                          : isWrongAnswer
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duraiton-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden">
